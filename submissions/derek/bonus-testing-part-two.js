...
mealsPerDay.forEach( function(item, index, array) {
  ...
  if ( averageMealsPerDay < 4 && tooHungryDay === 0) { tooHungryDay = index + 1;}
});
...
expect( tooHungryDay <= mealsPerDay.length, 'tooHungryDay of: ' + tooHungryDay + ' days is more than items in our mealsPerDay array', 'tooHungryDay of day: ' + tooHungryDay + ' is within the range of days in our array');
