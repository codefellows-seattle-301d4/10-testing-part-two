...
tooHungryDay = parseInt(eatCaretaker(mealsPerDay));
...
expect(
  ...
  'tooHungryDay is ' + tooHungryDay + ', but should be less than ' + mealsPerDay.length,
  'the caretaker will be eaten after day ' + tooHungryDay);
